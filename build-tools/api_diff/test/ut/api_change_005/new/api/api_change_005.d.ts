...
declare namespace abilityAccessCtrl {
  ...
  interface AtManager {
     ...
     * @since 9
     */
    revokeUserGrantedPermission(tokenID: string, permissionName: Permissions, permissionFlags: number): Promise<void>;
     ...
     * @since 9
     */
    getPermissionFlags(tokenID: string, permissionName: Permissions): Promise<number>;
