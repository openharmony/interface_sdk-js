...
declare namespace defaultAppManager {
   ...
   * @since 9
   */
  function isDefaultApplication(type: number, callback: AsyncCallback<boolean>): void;
   ...
   * @since 9
   */
   function isDefaultApplication(type: string, bbb:string, callback: AsyncCallback<boolean>): void;
