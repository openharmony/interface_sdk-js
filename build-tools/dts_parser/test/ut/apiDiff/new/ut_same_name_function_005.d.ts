 ...
 *
 * @param { string } src - source path.
 * @param { boolean } dest - destination path.
 * @param { AsyncCallback<void> } callback - Return the callback function.
 * @throws { BusinessError } 13900002 - No such file or directory
 * @throws { BusinessError } 13900004 - Interrupted system call
 * @throws { BusinessError } 13900005 - I/O error
 ...
 * @since 11
 */
declare function copyDir(src: string, dest: boolean, callback: AsyncCallback<void>): void;
 ...
 * @since 10
 */
declare function copyDir(url: string, dest: string, mode: number, callback: AsyncCallback<void, Array<ConflictFiles>>): void;