...
exports.updateETSUnionType = updateETSUnionType;
...
function updateETSUnionType(original, types) {
  if ((0, _ArktsObject.isSameNativeObject)(types, original.types)) {
    return original;
  }
  const update = (0, _private.updateThenAttach)(_generated.ETSUnionType.updateETSUnionType, _private.attachModifiers);
