...
exports.updateIfStatement = updateIfStatement;
...
function updateIfStatement(original, test, consequent, alternate) {
  ...
  const update = (0, _private.updateThenAttach)(_types.IfStatement.update, _private.attachModifiers);
