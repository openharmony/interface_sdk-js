...
exports.updateForOfStatement = updateForOfStatement;
...
function updateForOfStatement(original, left, right, body, isAwait) {
  ...
  const updateNode = (0, _private.updateThenAttach)(_generated.ForOfStatement.updateForOfStatement, _private.attachModifiers);
