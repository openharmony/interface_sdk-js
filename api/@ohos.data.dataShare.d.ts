...
declare namespace dataShare {
     ...
     * @StageModelOnly
     */
    function createDataShareHelperV9(context: Context, uri: string, callback: AsyncCallback<DataShareHelperV9>): void;
    function createDataShareHelperV9(context: Context, uri: string): Promise<DataShareHelperV9>;
