...
declare namespace media {
   ...
   * @since 12
   */
  type OnStateChangeHandle = (state: AVRecorderState, reason: StateChangeReason) => void;
  ...
  */
   ...
   * @since 12
   */
  type OnStateChangeHandler = (state: AVRecorderState, reason: StateChangeReason) => void;
