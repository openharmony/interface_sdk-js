 ...
 *
 * @typedef { Array<S> | Map<string | number, S> | 
 *     Set<S> | collections.Array<S> | collections.Map<string | number, S> | collections.Set<S> } CollectionType<S>
 * @syscap SystemCapability.ArkUI.ArkUI.Full
 * @stagemodelonly
 * @atomicservice
 * @since 23 dynamic
 ...
 * In this case defaultCreator and defaultSubCreator must be provided
 *
 * @extends ConnectOptions<T>
 * @syscap SystemCapability.ArkUI.ArkUI.Full
 * @stagemodelonly
 * @atomicservice
 * @since 23 dynamic
...
export declare class PersistenceV2 extends AppStorageV2 {
   ...
   * If the value for the given key is already available, return the value.
   * If not, add the key with value generated by calling defaultFunc and return it to caller.
   * This variant of overloaded function is to be used when T is a collection class
   * and both the defaultCreator and defaultSubCreator functions must be provided
   *
   * @param { ConnectOptionsCollections<T, S> | ConnectOptions<T> } type - Application level storage parameters.
   * @returns { T | undefined } the value of the existed key or the default value
   * @static
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
...
export declare enum CustomComponentLifecycleState {
     ...
     * or it could transfer to the disappeared state.
     *
     * @syscap SystemCapability.ArkUI.ArkUI.Full
     * @stagemodelonly
     * @crossplatform
     ...
     * The init, built, or recycled states could transfer to the disappeared state.
     *
     * @syscap SystemCapability.ArkUI.ArkUI.Full
     * @stagemodelonly
     * @crossplatform
 ...
 * Developers can modify state variables in this stage.
 *
