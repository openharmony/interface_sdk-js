...
export declare interface LifecycleForm {
   ...
   * @since 7
   * @sysCap AAFwk
   * @param intent Indicates the detailed information for creating a {@link formBindingData.FormBindingData}.
   ...
   * @return -
   */
  onVisibilityChanged?(newStatus: { [key: number]: number }): void;
...
export declare interface LifecycleData {
   ...
   */
  call?(method: string, arg: string, extras: Object): Object;
