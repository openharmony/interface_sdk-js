...
interface BlankInterface {
   ...
   *     <br>**NOTE**
   *     <br>This parameter cannot be set in percentage. If the value is negative, the default value is used. If the
   *     minimum size is larger than the available space of the container, it is used as the component size, and the
   *     component extends beyond the container.
...
declare class BlankAttribute extends CommonMethod<BlankAttribute> {
   ...
   *
   * @param { ResourceColor } value - Color to fill the blank.
