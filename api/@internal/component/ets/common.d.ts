...
/**
 * FlexAlign enumeration VerticalAlignDeclaration
 * @devices phone, tablet, car
 * @since 7
 */
...
/**
 * value :In the landscape layout component, the default alignment direction.
 * @devices phone, tablet, car
 * @since 7
 */
...
export declare class CommonMethod<T> {
  ...
  /**
   * This style allows you to set the window blurring degree and blurring style of the current component layout range.
   * If no value is set, the default value is 0% (no blurring).
   * Different blurring values and blurring styles cannot be set for multiple blurring areas.
   * @devices phone, tablet, car.
   * @since 7
   */
