 ...
 *
 * @param { string | number | File } file - file path，object or fd.
 * @param { string } mode - mode.
 * @returns { Promise<Stream> } return Promise
 * @throws { BusinessError } 13900001 - Operation not permitted
 * @throws { BusinessError } 13900002 - No such file or directory
 ...
 * @since 9
 */
declare function createRandomAccessFile(file: string | number | File, mode: string): Promise<Stream>;
 ...
 * @since 9
 */
declare function createRandomAccessFile(file: string | number | File, mode: string, callback: AsyncCallback<Stream>): void;
 ...
 * @param { string | number | File } file - file path，object or fd.
 * @param { string } mode - mode.
 * @returns { Stream } createRandomAccessFile
 * @throws { BusinessError } 13900001 - Operation not permitted
 * @throws { BusinessError } 13900002 - No such file or directory
 * @throws { BusinessError } 13900004 - Interrupted system call
 * @throws { BusinessError } 13900006 - No such device or address
 ...
 * @since 9
 */
declare function createRandomAccessFileSync(file: string | number | File, mode: string): Stream;
...
declare interface RandomAccessFile {
   ...
   * @since 10
   */
  setFilePointerSync(fp : number): void;
