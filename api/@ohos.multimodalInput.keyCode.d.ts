...
export declare enum KeyCode {
    ...
    KEYCODE_BUTTON_C = 2303,
    KEYCODE_BUTTON_X = 2304,
    KEYCODE_BUTTON_Y = 2305,
    KEYCODE_BUTTON_Z = 2306,
    ...
    KEYCODE_BUTTON_TRIGGER = 2401,
    KEYCODE_BUTTON_THUMB = 2402,
    KEYCODE_BUTTON_THUMB2 = 2403,
    KEYCODE_BUTTON_TOP = 2404,
    KEYCODE_BUTTON_TOP2 = 2405,
    KEYCODE_BUTTON_PINKIE = 2406,
    KEYCODE_BUTTON_BASE1 = 2407,
    KEYCODE_BUTTON_BASE2 = 2408,
    KEYCODE_BUTTON_BASE3 = 2409,
    KEYCODE_BUTTON_BASE4 = 2410,
    KEYCODE_BUTTON_BASE5 = 2411,
    KEYCODE_BUTTON_BASE6 = 2412,
    KEYCODE_BUTTON_BASE7 = 2413,
    KEYCODE_BUTTON_BASE8 = 2414,
    KEYCODE_BUTTON_BASE9 = 2415,
    KEYCODE_BUTTON_DEAD = 2416,
    KEYCODE_SLEEP = 2600,
    ...
    KEYCODE_BTN_8 = 3108,
    KEYCODE_BTN_9 = 3109,
    KEYCODE_BRL_DOT1 = 3201,
    KEYCODE_BRL_DOT2 = 3202,
    KEYCODE_BRL_DOT3 = 3203,
    KEYCODE_BRL_DOT4 = 3204,
    KEYCODE_BRL_DOT5 = 3205,
    KEYCODE_BRL_DOT6 = 3206,
    KEYCODE_BRL_DOT7 = 3207,
    KEYCODE_BRL_DOT8 = 3208,
    KEYCODE_BRL_DOT9 = 3209,
    KEYCODE_BRL_DOT10 = 3210,
    KEYCODE_LEFT_KNOB_ROLL_UP = 10001,
    KEYCODE_LEFT_KNOB_ROLL_DOWN = 10002,
    KEYCODE_LEFT_KNOB = 10003,
    KEYCODE_RIGHT_KNOB_ROLL_UP = 10004,
    KEYCODE_RIGHT_KNOB_ROLL_DOWN = 10005,
    KEYCODE_RIGHT_KNOB = 10006,
    KEYCODE_VOICE_SOURCE_SWITCH = 10007,
