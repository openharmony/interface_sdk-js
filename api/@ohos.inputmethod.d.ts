...
declare namespace inputMethod {
    /**
     * Errorcode 12800201.The permissions check fails.
     * @syscap SystemCapability.MiscServices.InputMethodFramework
     * @since 9
     */
    ...
    /**
     * Errorcode 12800401.The parameters check fails.
     * @syscap SystemCapability.MiscServices.InputMethodFramework
     * @since 9
     */
    ...
    /**
     * Errorcode 12800801.Call unsupported api.
     * @syscap SystemCapability.MiscServices.InputMethodFramework
     * @since 9
     */
     ...
     * @throws {BusinessError} 12800401 - permissions check fails.
