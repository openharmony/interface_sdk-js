 ...
 * > [XComponentNode]{@link ./XComponentNode:XComponentNode} and the [BuilderNode]{@link BuilderNode} holding a
 ...
 * > [BuilderNode]{@link BuilderNode} scenarios: [Badge]{@link ../@internal/component/ets/badge},
 * > [Blank]{@link ../@internal/component/ets/blank}, [Button]{@link ../@internal/component/ets/button},
 * > [CanvasGradient]{@link ../@internal/component/ets/canvas},
 * > [CanvasPattern]{@link ../@internal/component/ets/canvas},
 * > [CanvasRenderingContext2D]{@link ../@internal/component/ets/canvas},
 * > [Canvas]{@link ../@internal/component/ets/canvas}, [CheckboxGroup]{@link ../@internal/component/ets/checkboxgroup},
 * > [Checkbox]{@link ../@internal/component/ets/checkbox}, [Circle]{@link ../@internal/component/ets/circle},
 * > [ColumnSplit]{@link ../@internal/component/ets/column_split}, [Column]{@link ../@internal/component/ets/column},
 * > [ContainerSpan]{@link ../@internal/component/ets/container_span},
 * > [Counter]{@link ../@internal/component/ets/counter}, [DataPanel]{@link ../@internal/component/ets/data_panel},
 ...
 * > [Hyperlink]{@link ../@internal/component/ets/hyperlink}, [ImageBitmap]{@link ../@internal/component/ets/canvas},
 ...
 * > [OffscreenCanvas]{@link ../@internal/component/ets/canvas}, [Path2D]{@link ../@internal/component/ets/canvas},
 ...
 * > [TextArea]{@link ../@internal/component/ets/text_area}, [TextClock]{@link ../@internal/component/ets/text_clock},
 * > [TextInput]{@link ../@internal/component/ets/text_input}, [TextTimer]{@link ../@internal/component/ets/text_timer},
 * > [Text]{@link ../@internal/component/ets/text}, [Toggle]{@link ../@internal/component/ets/toggle},
 * > [Video]{@link ../@internal/component/ets/video} (excluding full-screen playback),
 ...
 * > [DatePicker]{@link ../@internal/component/ets/date_picker}, [ForEach]{@link ../@internal/component/ets/for_each},
 * > [Grid]{@link ../@internal/component/ets/grid},
 * > [if/else](docroot://ui/rendering-control/arkts-rendering-control-ifelse.md),
 * > [LazyForEach]{@link ../@internal/component/ets/lazy_for_each}, [List]{@link ../@internal/component/ets/list},
 * > [Scroll]{@link ../@internal/component/ets/scroll}, [Swiper]{@link ../@internal/component/ets/swiper},
 * > [TimePicker]{@link ../@internal/component/ets/time_picker}, custom components decorated with
 * > [@Component](docroot://ui/state-management/arkts-create-custom-components.md#component),
 * > [NodeContainer]{@link ../@internal/component/ets/node_container}, and [FrameNode]{@link ./FrameNode} and
 * > [RenderNode]{@link ./RenderNode:RenderNode} mounted to
 * > [NodeContainer]{@link ../@internal/component/ets/node_container}.
 * >
 * > - For details, see
 * > [Rendering and Drawing Video and Button Components at the Same Layer](docroot://web/web-same-layer.md).
 *
...
export interface RenderOptions {
  /**
   * Ideal size of the node. When the content generated by the BuilderNode is embedded into another RenderNode for
   * display, **selfIdealSize** must be explicitly specified; otherwise the default parent component layout constraint
   * for the node within **@Builder** is [0, 0].
   *
  ...
  /**
   * Rendering type of the node. When the value is **NodeRenderType.RENDER_TYPE_TEXTURE**, the setting takes effect only
   * when the root node of the component tree held by BuilderNode is a custom component.
   *
...
export interface BuildOptions {
   ...
   * LocalStorage. If LocalStorage is also passed through a custom component's constructor, the constructor parameter
   * takes precedence.
   *
   * Default value: **null**.
   *
  ...
  /**
   * Whether two-way synchronization is supported between the
...
/**
 * Defines the type of input event to be posted. For details, see [postInputEvent]{@link BuilderNode#postInputEvent}.
 *
 ...
 * components. A BuilderNode can be used only as a leaf node. It supports generating a component tree through
 * **@Builder**, implementing component reuse and recycling, cross-node event posting, and state synchronization. It is
 * suitable for scenarios where custom component nodes are dynamically created and managed within applications. For
 * details, see [BuilderNode Development](docroot://ui/arkts-user-defined-arktsNode-builderNode.md). For best practices,
 * see
 * [Dynamic Component Creation: Dynamically Adding, Updating, and Deleting Components](https://developer.huawei.com/consumer/en/doc/harmonyos-guides/arkts-ui-component-dynamic-creation#dynamically-adding-updating-and-deleting-components).
 *
 * Compared with **BuilderNode**, **ReactiveBuilderNode** can generate a component tree through the stateless UI method
 * **@Builder** with multiple parameters. It is suitable for scenarios that require multi-parameter data binding and
 * reactive UI dynamic updates.
 *
 * > **NOTE**
 * >
 ...
 * > [Span]{@link ../@internal/component/ets/span}, [ContainerSpan]{@link ../@internal/component/ets/container_span},
 * > [SymbolSpan]{@link ../@internal/component/ets/symbol_span}, or a custom component, an additional
 * > [FrameNode]{@link ./FrameNode} will be generated and displayed as "BuilderProxyNode" in the node tree. This causes
 * > tree structure changes and affects testing processes such as event propagation. For details, see
 ...
 * >
 * > - Custom components under **BuilderNode** support the [@Prop](docroot://ui/state-management/arkts-prop.md)
...
export class BuilderNode<Args extends Object[]> {
   ...
   *     **uiContext** must be a valid value, that is, the UI context must be correct. If an invalid value is passed in
   *     or if no value is specified, creation will fail.
   * @param { RenderOptions } options - Optional parameters for creating a BuilderNode, used to specify the ideal size
   *     and rendering type of the node.
   ...
   * > **NOTE**
   * >
   * > - When nesting **@Builder**, ensure that the input parameter objects for the inner and outer **@Builder** methods
   * > are consistent.
   * >
   * > - The outermost **@Builder** supports only one input parameter.
   * >
   * > - The build parameter uses the pass-by-value semantics. To implement state updates, you must use the
   ...
   * > [FrameNode]{@link ./FrameNode} and [RenderNode]{@link ./RenderNode:RenderNode} objects are also dereferenced from
   ...
   * >
   * > - The BuilderNode object maintains references to its entity nodes. When the BuilderNode frontend object is no
   * > longer required for managing backend nodes, call the [dispose]{@link BuilderNode#dispose} API to unbind the
   * > frontend and backend objects.
   *
   ...
   * [build(builder: WrappedBuilder\<Args>, arg?: Object)]{@link BuilderNode#build(builder: WrappedBuilder<Args>, arg?: Object)}
   * API, this API supports builder configuration parameters to configure the build behavior of **@Builder**. For
   * details about the attributes, see [BuildOptions]{@link BuildOptions}.
   *
   * > **NOTE**
   * >
   ...
   * @param { Object } arg - Argument of the builder. Only one input parameter is supported, and the type of the input
   *     parameter must be consistent with the type defined by @Builder.
   * @param { BuildOptions } options - Build options, used to configure the build behavior of **@Builder**. For details
   *     about the attributes, see [BuildOptions]{@link BuildOptions}.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
   * @atomicservice
   ...
   * to the [build]{@link BuilderNode#build(builder: WrappedBuilder<Args>, arg?: Object)} API. When updating a custom
   * component, define the variables used in the component as [@Prop](docroot://ui/state-management/arkts-prop.md)
   * decorated properties.
   *
   * @param { Object } arg - Parameter used to update the BuilderNode. It is of the same type as the parameter passed to
   *     the [build]{@link BuilderNode#build(builder: WrappedBuilder<Args>, arg?: Object)} API.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
   * @atomicservice [since 12]
   ...
   *
   * @returns { FrameNode | null } **FrameNode** object held by the BuilderNode, used to mount the BuilderNode as a
   *     child node to another FrameNode. If no such object is held by the BuilderNode, null is returned.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
   * @atomicservice [since 12]
  ...
  /**
   * Posts a raw touch event to the FrameNode created by this BuilderNode. This is suitable for scenarios where a parent
   * component's received touch events need to be forwarded to the internal components of a BuilderNode in a custom
   * NodeContainer, enabling the internal components to respond to touch interactions.
   *
   * **postTouchEvent** posts the event from a middle node in the component tree downwards. To ensure the event is
   * posted correctly, it needs to be transformed into the coordinate system of the parent component, as shown in the
   * figure below.
   *
   ...
   * > internally, so you can directly post the touch event without additional adjustments.
   * >
   * > - The **postTouchEvent** API can be called only once for the same timestamp.<!--Del-->
   * >
   * > - This API cannot be called by [UIExtensionComponent]{@link ../@internal/component/ets/ui_extension_component}.
   *
   * <!--DelEnd-->
   *
   * @param { TouchEvent } event - Touch event to be posted to the FrameNode created by the BuilderNode.
   * @returns { boolean } Whether the event is posted successfully. The value **true** indicates that a component
   *     capable of responding to the event is hit; **false** indicates that no such component is hit.
   *     <br>**NOTE**
   ...
   *
   * The BuilderNode uses reuse and [recycle]{@link BuilderNode#recycle} to transfer reuse events between its internal
   * and external custom components. For specific usage scenarios, see
   ...
   *     **undefined**, in which case the custom components in the BuilderNode will use the data source at the time of
   *     construction.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
  ...
  /**
   * Posts the specified input event to the target node managed by the BuilderNode. This is suitable for scenarios where
   * a parent component's received touch, mouse, or axis events need to be forwarded to the internal components of a
   * BuilderNode in a custom NodeContainer, enabling the internal components to respond to corresponding interactions.
   *
   ...
   * >
   * > - Mouse left-click events are automatically converted to touch events. When forwarding, avoid binding both touch
   * > events and mouse events at the outer layer, as this may cause coordinate offsets. This is because **SourceType**
   * > does not change during event conversion. For details, see [onTouch]{@link CommonMethod#onTouch}.
   * >
   * > - When an [axis event]{@link AxisEvent} is injected, it cannot trigger
   * > [RotationGesture]{@link ../@internal/component/ets/gesture}, because the axis event does not include rotation
   * > axis information.
   * >
   ...
   * > touch events and the **scrollStep** field for axis events. Ensure the completeness of the event, for example,
   * > both **DOWN** and **UP** in [TouchType]{@link TouchType} must be present to prevent undefined behavior.
   * >
   ...
   * >
   * > - Avoid forwarding a single event multiple times.<!--Del--> This API cannot be called by
   * > [UIExtensionComponent]{@link ../@internal/component/ets/ui_extension_component}.<!--DelEnd-->
   *
   * @param { InputEventType } event - Input event to post.
   * @returns { boolean } Whether the event is successfully posted. Returns **true** if the event is successfully
   *     posted; returns **false** otherwise.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @atomicservice
   * @since 20 dynamic
   ...
   * > coordinate offsets. This is because [SourceType]{@link SourceType} does not change during the event conversion.
   ...
   * >
   * > - The **postTouchEvent** API needs to provide the gesture coordinates relative to the local coordinates of the
   * > target component, and the **postInputEventWithStrategy** API needs to provide the gesture coordinates relative to
   * > the window coordinates of the target component.
   * >
   * > - The same event can be forwarded multiple times.<!--Del--> This API cannot be called by
   * > [UIExtensionComponent]{@link ../@internal/component/ets/ui_extension_component}.<!--DelEnd-->
   *
   * @param { InputEventType } event - Input event to post.
   * @param { CompetitionStrategy } [competitionStrategy] - Gesture competition strategy for posting events.
   *     **CompetitionStrategy.DEFAULT** indicates the non-competition mode (gestures of the target component and the
   *     current component do not compete), which applies to scenarios where the current component and the target
   *     component handle gestures independently without competing for the same event.
   *     **CompetitionStrategy.COMPETITION** indicates the competition mode (gestures of the target component and the
   *     current component compete), which applies to scenarios where the current component and the target component
   *     need to compete for the same gesture event. If not specified, **CompetitionStrategy.DEFAULT** (non-competition)
   *     is used by default.
   * @returns { boolean } Whether the event is successfully posted. Returns **true** if the operation is successful;
  ...
  /**
   * Sets whether the current **BuilderNode** object inherits the freeze policy from its parent component's custom
   * components. When inheritance is disabled (set to **false**), the object's freeze policy is set to **false**, which
   ...
   *
   * @param { boolean } enabled - Whether the **BuilderNode** object inherits the freeze policy from its parent
   ...
   *     <br>**Note:** The **true** value takes effect only when the parent component is a custom component,
   ...
   * reference, subsequent API calls may cause crashes or return default values. Due to service requirements, a node may
   * still be called after being disposed. Therefore, this API is provided for you to check the validity of a node
   * before operating on it, thereby avoiding potential risks.
   *
 ...
 * [getRenderNode]{@link ./FrameNode:FrameNode#getRenderNode} method of the [FrameNode]{@link ./FrameNode}, avoid
 * setting the attributes or operating the subnodes through APIs of [RenderNode]{@link ./RenderNode:RenderNode}.
 *
 * @syscap SystemCapability.ArkUI.ArkUI.Full
 * @stagemodelonly
 * @crossplatform
...
export class ReactiveBuilderNode<Args extends Object[]> {
   ...
   * @param { UIContext } uiContext - UI context. For details about how to obtain it, see
   *     [Obtaining UI Context](docroot://reference/apis-arkui/js-apis-arkui-node.md#obtaining-ui-context).
   *     **uiContext** must be a valid value, that is, the UI context must be correct. If this parameter is invalid or
   *     not set, the creation will fail.
   * @param { RenderOptions } [options] - Optional parameter for constructing **ReactiveBuilderNode**. This parameter is
   *     used to construct the ideal size of the node and the rendering type of the node.
   *     <br>Default value: **undefined**.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
   ...
   * > are consistent.
   * >
   * > - To operate objects in a ReactiveBuilderNode, ensure that the reference to the ReactiveBuilderNode is not
   * > garbage collected. When a ReactiveBuilderNode object is garbage collected by the virtual machine, the associated
   * > [FrameNode]{@link ./FrameNode} and [RenderNode]{@link ./RenderNode:RenderNode} objects are also dereferenced from
   * > the backend node tree. This means that any FrameNode objects obtained from a ReactiveBuilderNode will no longer
   * > correspond to any actual node if the ReactiveBuilderNode is garbage collected.
   * >
   * > - The ReactiveBuilderNode object maintains references to its underlying entity nodes. When the
   * > ReactiveBuilderNode frontend object is no longer required for managing backend nodes, call the
   * > [dispose]{@link ReactiveBuilderNode#dispose} API to release node references and unbind frontend and backend
   * > nodes.
   *
   * @param { WrappedBuilder<Args> } builder - Stateless UI method
   *     [@Builder](docroot://ui/state-management/arkts-builder.md) required for creating a component tree.
   * @param { BuildOptions } config - Build options. All attributes in **BuildOptions** are optional. For the default
   *     values of each attribute, see the description of **BuildOptions**.
   * @param { Args } args - Arguments of the builder, which are used to construct the builder function encapsulated by
   *     the **WrappedBuilder** object. Multiple arguments are supported. The default value is **undefined**.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
   * @atomicservice
   ...
   *
   * @returns { FrameNode | null } **FrameNode** object held by the ReactiveBuilderNode, which is used to mount the
   *     ReactiveBuilderNode as a child node onto another FrameNode. If no such object is held by the
   *     ReactiveBuilderNode, null is returned.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
   * @atomicservice
  ...
  /**
   * Posts a raw touch event to the FrameNode created by a ReactiveBuilderNode. This is suitable for scenarios where a
   * parent component's received touch events need to be forwarded to the internal components of a ReactiveBuilderNode
   * in a custom NodeContainer, enabling the internal components to respond to touch interactions.
   *
   * **postTouchEvent** posts the event from a middle node in the component tree downwards. To ensure the event is
   * posted correctly, it needs to be transformed into the coordinate system of the parent component, as shown in the
   * figure below.
   ...
   * > so you can directly post the touch event without additional adjustments.
   * >
   * > The **postTouchEvent** API can be called only once for the same timestamp.<!--Del-->
   * >
   * > The **postTouchEvent** parameter does not support
   * > [UIExtensionComponent]{@link ../@internal/component/ets/ui_extension_component}.
   *
   * <!--DelEnd-->
   *
   * @param { TouchEvent } event - Touch event to post to the FrameNode created by a ReactiveBuilderNode.
   * @returns { boolean } Whether the event is posted successfully. The value **true** indicates that a component
   *     capable of responding to the event is hit; **false** indicates that no such component is hit.
   *     <br>**NOTE**
   *     <br>If the event does not hit the expected component, ensure the following:
   ...
   * [Canceling the Reference to the Entity Node](docroot://ui/arkts-user-defined-arktsNode-builderNode.md#canceling-the-reference-to-the-entity-node).
   * Since API version 26.0.0, custom components in **ReactiveBuilderNode** support V2 component reuse. For details, see
   * [@ReusableV2 Decorator: Reusing Components](docroot://ui/state-management/arkts-new-reusableV2.md).
   *
   ...
   *     is **undefined**, in which case the custom components in the ReactiveBuilderNode will use the data source at
  ...
  /**
   * Recycles the custom component in ReactiveBuilderNode. Component recycling is part of the component reuse mechanism.
   * For details, see [@Reusable Decorator: Reusing V1 Components](docroot://ui/state-management/arkts-reusable.md).
   * Since API version 26.0.0, custom components in **ReactiveBuilderNode** support V2 component reuse. For details, see
   * [@ReusableV2 Decorator: Reusing Components](docroot://ui/state-management/arkts-new-reusableV2.md).
   *
   * ReactiveBuilderNode completes the reuse event transfer between internal and external custom components through
  ...
  /**
   * Refreshes the data state of the **ReactiveBuilderNode** based on the changes of bound data. If the bound parameters
   * used in the builder function encapsulated by the
   * [WrappedBuilder](docroot://ui/state-management/arkts-wrapBuilder.md) object in the ReactiveBuilderNode are class
   * instances decorated by V1 decorators (such as **@Observed**), you need to manually call this API to update data
   * after the data of this class changes. If the bound parameters are class instances decorated by the V2 decorator (
   * such as **@ObservedV2**), the data can be automatically updated without manual calling.
   *
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @stagemodelonly
   * @crossplatform
  ...
  /**
   * Posts the input event to the target node managed by the **ReactiveBuilderNode**. This is suitable for scenarios
   * where a parent component's received touch, mouse, or axis events need to be forwarded to the internal components of
   * a ReactiveBuilderNode in a custom NodeContainer, enabling the internal components to respond to corresponding
   * interactions.
   *
   * **offsetA** indicates the **BuilderNode**'s offset relative to its parent component, **offsetB** the hit position's
   * offset relative to the **BuilderNode**, **offsetC** the composite offset (offsetA + offsetB) passed to the
   * **postInputEvent**.
   *
   * ![API coordinate conversion example](docroot://reference/apis-arkui/figures/postInputEvent-point.png)
   *
   * > **NOTE**
   * >
   * > The passed coordinates must be converted to the unit of px. The sample code below demonstrates how to perform
   ...
   * >
   * > Mouse left-click events are automatically converted to touch events. When forwarding, avoid binding both touch
   * > events and mouse events at the outer layer, as this may cause coordinate offsets. This is because
   * > [SourceType]{@link SourceType} of the event does not change during the event conversion. For details about the
   * > specifications, see [onTouch]{@link CommonMethod#onTouch}.
   * >
   * > When an [axis event]{@link AxisEvent} is injected, it cannot trigger
   * > [RotationGesture]{@link ../@internal/component/ets/gesture}, because the axis event does not include rotation
   * > axis information.
   ...
   * > event, for example, both **DOWN** and **UP** in [TouchType]{@link TouchType} must be present to prevent undefined
   * > behavior.
   * >
   * > [webview]{@link @ohos.web.webview:webview} has already handled coordinate system transformation, so events can be
   * > posted.
   * >
   * > The **postTouchEvent** API needs to provide the gesture coordinates relative to the local coordinates of the
   * > target component, and the **postInputEvent** API needs to provide the gesture coordinates relative to the window
   ...
   * >
   * > The **postInputEvent** parameter does not support
   * > [UIExtensionComponent]{@link ../@internal/component/ets/ui_extension_component}.<!--DelEnd-->
   *
   * @param { InputEventType } event - Input event to post.
   * @returns { boolean } Whether the event is successfully posted. Returns **true** if the event is successfully
   ...
   * ReactiveBuilderNode, and **offsetC** is the sum of **offsetA** and **offsetB**. The value of **offsetC** is used as
   * the value of the **window** parameter in **event** and passed to the **postInputEventWithStrategy** method. For
   ...
   * @param { InputEventType } event - Input event to post.
   * @param { CompetitionStrategy } [competitionStrategy] - Gesture competition strategy for posting events.
   *     **CompetitionStrategy.DEFAULT** indicates the non-competition mode (the gestures of the target component and
   *     the current component do not compete), which applies to scenarios where the current component and the target
   *     component handle gestures independently without competing for the same event.
   *     **CompetitionStrategy.COMPETITION** indicates the competition mode (the gestures of the target component and
   *     the current component compete), which applies to scenarios where the current component and the target component
   *     need to compete for the same gesture event. If not specified, **CompetitionStrategy.DEFAULT** (non-competition)
   *     is used by default.
   * @returns { boolean } Whether the event is successfully posted. Returns **true** if the operation is successful;
   *     returns **false** otherwise.
  ...
  /**
   * Sets whether the current **ReactiveBuilderNode** object inherits the freeze policy from its parent component's
   * custom components. When inheritance is disabled (set to **false**), the **ReactiveBuilderNode** object's freeze
   * policy is set to **false**, which means its associated node remains unfrozen even in an inactive state.
   *
   * > **NOTE**
   * >
   ...
   * > component, **BuilderNode**, **ComponentContent**, **ReactiveBuilderNode**, or **ReactiveComponentContent**, the
   * > freeze policy of the parent component is inherited. If the child component is a custom component, the freeze
   * > policy of the ReactiveBuilderNode is not transferred to the child component.
   *
   * @param { boolean } enabled - Whether the **ReactiveBuilderNode** object inherits the freeze policy from its parent
   *     component's custom components. The value **true** means to inherit the freeze policy from parent component's
   *     custom components, and **false** means the opposite. The **true** value takes effect only when the parent
   ...
   * release this reference, subsequent API calls may cause crashes or return default values. Due to service
   * requirements, a node may still be called after being disposed. Therefore, this API is provided for you to check the
   * validity of a node before operating on it, thereby avoiding potential risks.
   *
   * @returns { boolean } Whether the reference to the backend node is released. The value **true** means that the
   *     reference to backend node is released, and **false** means the opposite.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
