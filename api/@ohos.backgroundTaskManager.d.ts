 ...
 * @deprecated since 9
 * @useinstead @ohos.resourceschedule.backgroundTaskMgr
 */
declare namespace backgroundTaskManager {
     ...
     * @syscap SystemCapability.ResourceSchedule.BackgroundTaskManager.TransientTask
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.DelaySuspendInfo
     */
     ...
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.cancelSuspendDelay
     */
     ...
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.getRemainingDelayTime
     */
     ...
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.requestSuspendDelay
     */
     ...
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.startBackgroundRunning
     */
     ...
     * @param context app running context.
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.stopBackgroundRunning
     */
     ...
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.applyEfficiencyResources
     */
      ...
      * @systemapi Hide this for inner system use.
      * @deprecated since 9
      * @useinstead @ohos.resourceschedule.backgroundTaskMgr.resetAllEfficiencyResources
      */
     ...
     * @syscap SystemCapability.ResourceSchedule.BackgroundTaskManager.ContinuousTask
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.BackgroundMode
     */
     ...
     * @systemapi Hide this for inner system use.
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.ResourceType
     */
     ...
     * @systemapi Hide this for inner system use.
     * @deprecated since 9
     * @useinstead @ohos.resourceschedule.backgroundTaskMgr.EfficiencyResourcesRequest
     */
