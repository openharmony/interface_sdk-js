...
declare namespace util {
	...
	class Scope{
         ...
         * @return If the value is within the current range return true,oherwise return false.
         */
         ...
         * @return If the current range is within the given range return true,oherwise return false.
         */ 
	...
	class Base64{
         ...
         */ 
		encodeAsync(src: Uint8Array): Promise<Uint8Array>;
        /**
         ...
         */
		 encodeToStringAsync(src: Uint8Array): Promise<string>;
        /**
         ...
         */ 
		decodeAsync(src: Uint8Array | string): Promise<Uint8Array>;
	}
}
export default util;