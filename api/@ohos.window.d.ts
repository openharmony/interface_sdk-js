...
declare namespace window {
   ...
   * @param { WindowSnapshotConfiguration } configs - Configuration for getting windows' snapshot.
   ...
   * @arkts 1.1&1.2
   */
  function getMainWindowSnapshot(windowId: Array<number>, configs: WindowSnapshotConfiguration): Promise<Array<image.PixelMap>>;
