...
declare namespace PiPWindow {
  ...
  interface PiPConfiguration {
    ...
    /**
     * Describes the width of content to be displayed in PiP window, measured in px. For adjusting PiP window aspect ratio.
     *
     * @type { ?number }
     * @syscap SystemCapability.Window.SessionManager
     * @since 11
    ...
    /**
     * Describes the height of content to be displayed in PiP window, measured in px. For adjusting PiP window aspect ratio.
     *
     * @type { ?number }
     * @syscap SystemCapability.Window.SessionManager
     * @since 11
  ...
  interface PiPController {
     ...
     * @param { number } width - Indicate the width of the content, measured in px. The width can consist of only digits and above 0.
     * @param { number } height - Indicate the height of the content, measured in px. The height can consist of only digits and above 0.
     * @throws { BusinessError } 401 - Params error. Possible causes: 1. Mandatory parameters are left unspecified.
     *                                                                2. Incorrect parameter types.
     * @syscap SystemCapability.Window.SessionManager
     * @since 11
    ...
    /**
     * Update source content size to adjust PiP window aspect ratio.
     * @param { int } width - Indicate the width of the content, measured in px. The width can consist of only digits and above 0.
     * @param { int } height - Indicate the height of the content, measured in px. The height can consist of only digits and above 0.
