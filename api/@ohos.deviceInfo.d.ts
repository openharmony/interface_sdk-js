...
/**
   ...
   *
   * @param { string | number } version - API version number to be verified. The value can be an integer or string format.
   ...
   *     input parameter version number; **false** indicates that the current device's API version is lower than the
   *     input version number, or the input version number is in an invaild format, or the specified version does not
   *     exit.
   * @syscap SystemCapability.Startup.SystemInfo
   * @FaAndStageModel
   * @crossplatform
