...
export {
    ...
    IntentionCode, Key, KeyAction, KeyCode, KeyEvent, MouseAction, MouseEvent, MouseToolType, PanelFlag, PanelInfo,
    PanelType, Pattern, PatternOptions, Pinch, Rotate, SourceType, ThreeFingersSwipe, ThreeFingersTap, ToolType, Touch,
    TouchEvent, inputConsumer, inputDevice, inputDeviceCooperate, inputEventClient, inputMonitor, pointer, shortKey
};
