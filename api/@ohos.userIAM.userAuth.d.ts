...
declare namespace userAuth {
  ...
  /**
   * The device owner recognition result.
   *
   * @syscap SystemCapability.UserIAM.UserAuth.Core
   * @stagemodelonly
   * @atomicservice
   * @since 26.0.0 dynamic&static
   */
  enum OwnerRecognitionResult {
    /**
     * Uncertain about the owner.
     *
     * @syscap SystemCapability.UserIAM.UserAuth.Core
     * @stagemodelonly
     * @atomicservice
  ...
  /**
   * Callback invoked when the device owner recognition result changes.
   *
   * @param { OwnerRecognitionResult } result - The device owner recognition result.
   * @param { UserAuth.AuthTrustLevel } [authTrustLevel] - Trust level of the authentication result.
   * @syscap SystemCapability.UserIAM.UserAuth.Core
   * @stagemodelonly
   * @atomicservice
   * @since 26.0.0 dynamic&static
   */
  type OwnerRecognitionCallback = (result: OwnerRecognitionResult, authTrustLevel?: UserAuth.AuthTrustLevel) => void;

  /**
   * Monitors user detection and changes in the device owner recognition result.
   *
   * @syscap SystemCapability.UserIAM.UserAuth.Core
   * @stagemodelonly
   * @atomicservice
   * @since 26.0.0 dynamic&static
   */
  interface UserDetectionMonitor {
    /**
     * Subscribes to commands from the device owner recognition result.
     *
     * @param { OwnerRecognitionCallback } callback - Handler that processes the device owner recognition result
     *     changes.
     * @throws { BusinessError } 12500002 - General operation error.
     * @syscap SystemCapability.UserIAM.UserAuth.Core
     * @stagemodelonly
     ...
     * @since 26.0.0 dynamic&static
     */
    onOwnerRecognition(callback: OwnerRecognitionCallback): void;

    /**
     * Cancels the subscription to the device owner recognition result.
     *
     * @param { OwnerRecognitionCallback } [callback] - Target callback to remove.
     * @throws { BusinessError } 12500002 - General operation error.
     * @syscap SystemCapability.UserIAM.UserAuth.Core
     * @stagemodelonly
     * @atomicservice
     * @since 26.0.0 dynamic&static
     */
    offOwnerRecognition(callback?: OwnerRecognitionCallback): void;
  }

  /**
   * Obtains the object that detects the user's identity status.
   *
   * @permission ohos.permission.ACCESS_BIOMETRIC
   * @returns { UserDetectionMonitor } UserDetectionMonitor instance obtained.
   * @throws { BusinessError } 201 - Permission denied.
   ...
   * @since 26.0.0 dynamic&static
   */
  function getUserDetectionMonitor(): UserDetectionMonitor;
}
