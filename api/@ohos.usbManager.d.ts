...
declare namespace usbManager {
  ...
  /**
   * Perform a USB port reset to reinitialize a usb device. The operation will attampt to restore the previous configuration
   ...
   * @returns { boolean } If the restart opration is successful, return {@code true}; if the restart operation fails, return {@code false}.
   * @throws { BusinessError } 401 - Parameter error. Possible causes:
   * <br>1.Mandatory parameters are left unspecified.
   * <br>2.Incorrect parameter types.
   ...
   * <br>1.The validity check of the input parameters is checked failed.
   * <br>2.The input parameters are obtained through a rational call chain, first using connectDevice to acquire the USBDevicePipe.
   * @syscap SystemCapability.USB.USBManager
   * @since 20
   */
