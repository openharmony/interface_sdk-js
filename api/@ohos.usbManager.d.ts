...
declare namespace usbManager {
  ...
  */
  ...
  interface USBDataTransferParams {
     ...
     *
     * @type { AsyncCallback<CallbackInfo> }
     * @syscap SystemCapability.USB.USBManager
     * @since 16
     */
    callback: AsyncCallback<CallbackInfo>;
   ...
   * <br>1.Mandatory parameters are left unspecified.
   * <br>2.Incorrect parameter types.  
   * @throws { BusinessError } 14400001 - service permission denied.
   * @throws { BusinessError } 14400006 - usb submit transmission operation successful.
   * @throws { BusinessError } 14400007 - usb submit transmission input/output error.
   * @throws { BusinessError } 14400008 - transmission invalid parameter.
   * @throws { BusinessError } 14400009 - no such device (it may have been disconnected).
   * @throws { BusinessError } 14400010 - transmission time out error.
   * @throws { BusinessError } 14400011 - transmission other error.
   * @throws { BusinessError } 14400012 - transmission overflow error.
   * @throws { BusinessError } 14400013 - insufficient memory.
   * @throws { BusinessError } 14400014 - interface does not support.
   * @throws { BusinessError } 14400015 - napi get params error.
   * @syscap SystemCapability.USB.USBManager
   * @since 16
   */
   ...
   * <br>2.Incorrect parameter types.  
   * @throws { BusinessError } 14400001 - service permission denied.
   * @throws { BusinessError } 14400007 - usb CancelTransfer input/output error.
   * @throws { BusinessError } 14400008 - transmission invalid parameter.
   * @throws { BusinessError } 14400015 - napi get params error.
   * @syscap SystemCapability.USB.USBManager
   * @since 16
