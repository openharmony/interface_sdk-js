...
import * as _BusinessAbilityInfo from './bundleManager/BusinessAbilityInfo';
...
declare namespace businessRouter {
   ...
   * @since 10
   */
  function queryBusinessAbilityInfos(filter: BusinessAbilityFilter, callback: AsyncCallback<Array<BusinessAbilityInfo>>): void;
   ...
   * @since 10
   */
  function queryBusinessAbilityInfos(filter: BusinessAbilityFilter): Promise<Array<BusinessAbilityInfo>>;
