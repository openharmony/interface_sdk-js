 ...
 * @kit ArkUI
 */
import { ResourceColor,MarkStyle } from './@ohos.arkui.component.Units' 
import { CommonMethod } from './@ohos.arkui.component.Common'
import { CheckBoxShape } from './@ohos.arkui.component.Enums'
/**
 ...
 * @since 11
 */
export declare class CheckboxGroupAttribute extends CommonMethod<CheckboxGroupAttribute> {
  /**
 ...
 * @since 11
 */
export declare const CheckboxGroup: CheckboxGroupInterface;
 ...
 * @since 11
 */
export declare const CheckboxGroupInstance: CheckboxGroupAttribute;
