...
declare namespace cert {
  ...
  interface CmsSignerConfig {
    ...
    /**
     * Whether to add the smime capabilities to the signature attributes.
     *
     * @type { ?boolean }
     * @default true
     * @syscap SystemCapability.Security.Cert
  ...
  interface CmsGeneratorOptions {
    ...
    /**
     * Whether the CMS final data not contains original data, the default value is false.
     *
     * @type { ?boolean }
     * @default false
     * @syscap SystemCapability.Security.Cert
  ...
  interface CmsGenerator {
     ...
     * @param { PrivateKeyinfo } keyInfo - the private key information of the signer certificate.
     * @param { CmsSignerOptions } options - the configuration options for CMS operation.
     * @throws { BusinessError } 401 - invalid parameters. Possible causes: 1. Mandatory parameters are left unspecified;
     * <br>2. Incorrect parameter types; 3. Parameter verification failed.
     * @throws { BusinessError } 801 - this operation is not supported.
     * @throws { BusinessError } 19020001 - memory error.
    ...
    /**
     * Used to obtain CMS final data, such as CMS signed data.
     *
     * @param { Uint8Array } data - The content data for CMS operation.
     * @param { CmsGeneratorOptions } [options] - The configuration options for the CMS operation.
     * @returns { Promise<Uint8Array | string> } The promise used to return the CMS final data.
     * @throws { BusinessError } 401 - invalid parameters. Possible causes: 1. Mandatory parameters are left unspecified;
     * <br>2. Incorrect parameter types; 3. Parameter verification failed.
     * @throws { BusinessError } 19020001 - memory error.
     * @throws { BusinessError } 19020002 - runtime error.
