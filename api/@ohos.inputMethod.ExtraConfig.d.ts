...
/**
 * @brief This module manages input method extension information. It enables the ArkUI editor to pass such information to the
...
/**
 * @brief Represents the extension information of an input method.
 *
 * @syscap SystemCapability.MiscServices.InputMethodFramework
 * @since 22 dynamic
 * @since 23 static
...
export interface InputMethodExtraConfig {
    /**
     * @brief Input method extension information, which is used to store custom key-value pairs. These key-value pairs can be 
