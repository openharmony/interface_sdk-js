...
declare namespace usageStatistics {
   ...
   *     If the query is successful, **err** is **undefined**, and data is true mean the application is idle in
   *     a particular period; false mean otherwise. Otherwise, **err** is an error object.
