...
import {
  ...
  WindowChangeType, ComponentEventType, WindowChangeOptions, ComponentEventOptions, TouchOptions
} from '@ohos.UiTest';
...
export {
  ...
  PerfMetric, PerfTestStrategy, PerfMeasureResult, PerfTest, TouchOptions
};
