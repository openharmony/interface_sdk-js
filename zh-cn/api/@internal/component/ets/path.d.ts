...
declare interface PathOptions {
  ...
  interface PathInterface {
     ...
     *
     * @param { object } value [since 7 - 17]
     * @param { PathOptions } [options] - Path绘制区域。<br/>异常值undefined和null按照无效值处理，本次设置不生效。 [since 18]
     * @returns { PathAttribute }
     * @syscap SystemCapability.ArkUI.ArkUI.Full
     * @crossplatform [since 10]
     * @form [since 9]
  ...
  declare class PathAttribute extends CommonShapeMethod<PathAttribute> {
    /**
     * 设置符合[SVG路径描述规范](docroot://reference/apis-arkui/arkui-ts/ts-drawing-components-path.md#svg路径描述规范)的命令字符串，单位为px。像素单位转换
     * 方法请参考[像素单位转换]{@link common}。
     *
     * @param { string } value - 线条绘制的路径。<br/>默认值：空字符串<br/>默认单位：px <br/>异常值undefined和null按照默认值处理。 [since 7 - 19]
     * @param { ResourceStr } value - 线条绘制的路径。<br/>默认值：空字符串<br/>默认单位：px <br/>异常值undefined和null按照默认值处理。 [since 20]
     * @returns { PathAttribute }
     * @syscap SystemCapability.ArkUI.ArkUI.Full
     * @crossplatform [since 10]
     * @form [since 9]
