...
declare enum RichEditorDeleteDirection {
  ...
  declare class RichEditorAttribute extends CommonMethod<RichEditorAttribute> {
     ...
     * @param { ResponseType } responseType - 菜单的响应类型。<br/> 默认值：<br/>ResponseType.LongPress [since 10 - 10]
     ...
     * @param { KeyboardOptions } [options] - 设置自定义键盘是否支持避让功能。 <br>传入undefined时默认不支持避让。 [since 12]
     * @param { CustomBuilder | ComponentContent } value - 自定义键盘。                     <br/>传入undefined时默认使用系统键盘。 [since 23]
