...
declare namespace commonEventManager {
   ...
   *
   * @param { CommonEventSubscribeInfo } subscribeInfo - 表示订阅信息。
   * @returns { Promise<CommonEventSubscriber> } Promise对象，返回创建成功的订阅者对象。
   * @throws { BusinessError } 401 - Parameter error. Possible causes: 1. Mandatory parameters are left unspecified;
   *     2. Incorrect parameter types; 3. Parameter verification failed.
   * @syscap SystemCapability.Notification.CommonEvent
   * @crossplatform [since 11]
  ...
  export enum Support {
     ...
     * [热等级定制开发指导](docroot://../../device-dev/subsystems/subsys-thermal_level.md)。<!--DelEnd-->
     *
     * @syscap SystemCapability.Notification.CommonEvent
     * @since 9 dynamic
     * @since 23 static
     ...
     * [@ohos.account.osAccount](docroot://reference/js-apis-osAccount.md)。
     *
     ...
     * [系统账号接口文档](docroot://reference/js-apis-osAccount.md)、
     * [分布式账号接口文档](docroot://reference/js-apis-distributed-account.md)。
     *
     * @syscap SystemCapability.Notification.CommonEvent
     * @since 9 dynamic
     * @since 23 static
     ...
     * [setShortcutVisibleForSelf](docroot://apis-ability-kit/js-apis-shortcutManager.md#shortcutmanagersetshortcutvisibleforself)
     * 成功时），会发送此公共事件。
     *
    ...
    /**
     * PC场景在有扩展数据磁盘场景下，表示数据盘是否为可使用的状态。在开机扩展磁盘挂载完成或者用户解锁屏后广播。
     *
     * 此事件仅在PC/2in1设备上支持
     *
     * @syscap SystemCapability.Notification.CommonEvent
