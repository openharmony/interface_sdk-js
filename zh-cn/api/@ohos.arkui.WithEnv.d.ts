...
export declare class WithEnvAttribute {
   ...
   * @param { T } value - 系统环境变量值。value的类型T对应WritableSystemEnvKey<T>中的类型T。当key为WritableEnvKey.FONT_SCALE时，
   *     value类型为number；当key为WritableEnvKey.DIRECTION时，value类型为Direction。
