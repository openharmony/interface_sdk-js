...
/**
 * PermissionRequestResult是权限申请的结果对象。开发者需先创建atManager实例，再调用requestPermissionsFromUser方法申请权限，该方法返回PermissionRequestResult
 * 对象，开发者可通过该对象的属性判断权限申请结果。权限申请整体流程及atManager的详细说明请参见[@ohos.abilityAccessCtrl (程序访问控制管理)]{@link @ohos.abilityAccessCtrl}
 * 。
 *
...
declare class PermissionRequestResult {
   ...
   * [ohos.permission.LOCATION](docroot://security/AccessToken/permissions-for-all-user.md#ohospermissionlocation)与
   ...
   * - 6：该权限为[manual_settings](docroot://security/AccessToken/app-permission-mgmt-overview.md#manual_settings手动设置授权)类型，只
