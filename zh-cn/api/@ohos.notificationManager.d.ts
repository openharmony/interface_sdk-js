...
declare namespace notificationManager {
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [isNotificationEnabled]{@link notificationManager#isNotificationEnabled(callback: AsyncCallback<boolean>)} 获取指定应用的通知使能状态。
   * @see [cancel]{@link notificationManager#cancel(id: int,label: string,callback: AsyncCallback<void>)} 根据通知ID和标签label取消已发布的通知。
   * @see [cancelAll]{@link notificationManager#cancelAll(callback: AsyncCallback<void>)} 取消当前应用所有已发布的通知。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [isNotificationEnabled]{@link notificationManager#isNotificationEnabled()} 查询当前应用通知授权状态。
   * @see [cancel]{@link notificationManager#cancel(id: int,label?: string)} 根据通知ID和标签label取消已发布的通知。
   * @see [cancelAll]{@link notificationManager#cancelAll()} 取消当前应用所有已发布的通知。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [publish]{@link notificationManager#publish(request: NotificationRequest,callback: AsyncCallback<void>)} 发布通知。
   * @see [cancelAll]{@link notificationManager#cancelAll(callback: AsyncCallback<void>)} 取消当前应用所有已发布的通知。
   * @see [cancelGroup]{@link notificationManager#cancelGroup(groupName: string,callback: AsyncCallback<void,void>)} 取消当前应用指定组下的通知。
   */
   ...
   * @see [publish]{@link notificationManager#publish(request: NotificationRequest, callback: AsyncCallback<void>)} 发布通知。
   * @see [cancelAll]{@link notificationManager#cancelAll()} 取消当前应用所有已发布的通知。
   * @see [cancelGroup]{@link notificationManager#cancelGroup(groupName: string)} 取消当前应用指定组下的通知。
   */
   ...
   * @since 23 static
   * @see [publish]{@link notificationManager#publish(request: NotificationRequest, callback: AsyncCallback<void>)} 发布通知。
   * @see [cancel]{@link notificationManager#cancel(id: int, label: string, callback: AsyncCallback<void>)} 取消已发布的通知。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [publish]{@link notificationManager#publish(request: NotificationRequest)} 发布通知。
   * @see [cancel]{@link notificationManager#cancel(id:int, label?: string)} 根据指定的通知ID取消已发布的通知。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [getSlot]{@link notificationManager#getSlot(slotType: SlotType,callback: AsyncCallback<NotificationSlot>)} 获取指定类型的通知渠道。
   * @see [removeSlot]{@link notificationManager#removeSlot(slotType: SlotType,callback: AsyncCallback<void>)} 删除当前应用指定类型的通知渠道。
   * @see [removeAllSlots]{@link notificationManager#removeAllSlots(callback: AsyncCallback<void>)} 删除所有渠道通知。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [getSlot]{@link notificationManager#getSlot(slotType: SlotTyp)} 获取指定类型的通知渠道。
   * @see [removeSlot]{@link notificationManager#removeSlot(slotType: SlotType)} 删除当前应用指定类型的通知渠道。
   * @see [removeAllSlots]{@link notificationManager#removeAllSlots()} 删除当前应用的所有渠道通知。
   */
   ...
   * @syscap SystemCapability.Notification.Notification
   * @since 9 dynamic
   * @see [addSlot]{@link notificationManager#addSlot(slotType: SlotType,callback: AsyncCallback<void>)} 创建通知频道。
   * @see [removeSlot]{@link notificationManager#removeSlot(slotType: SlotType, AsyncCallback<void>)} 删除指定类型的通知渠道。
   * @see [removeAllSlots]{@link notificationManager#removeAllSlots(callback: AsyncCallback)} 删除所有通知渠道。
   */
   ...
   * @syscap SystemCapability.Notification.Notification
   * @since 9 dynamic
   * @see [addSlot]{@link notificationManager#addSlot(slotType: SlotType)} 创建通知频道。
   * @see [removeSlot]{@link notificationManager#removeSlot(slotType: SlotType)} 删除指定类型的通知渠道。
   * @see [removeAllSlots]{@link notificationManager#removeAllSlots()} 删除所有通知渠道。
   */
   ...
   * @since 23 static
   * @see [addSlot]{@link notificationManager#addSlot(slotType: SlotType,callback: AsyncCallback<void>)} 创建通知频道。
   * @see [removeSlot]{@link notificationManager#removeSlot(slotType: SlotType,callback: AsyncCallback<void>)} 删除指定类型的通知渠道。
   * @see [removeAllSlots]{@link notificationManager#removeAllSlots(callback: AsyncCallback)} 删除所有通知渠道。
   */
   ...
   * @since 23 static
   * @see [addSlot]{@link notificationManager#addSlot(slotType: SlotType)} 创建通知频道。
   * @see [getSlot]{@link notificationManager#getSlot(slotType: SlotType)} 获取指定类型的通知渠道。
   * @see [removeAllSlots]{@link notificationManager#removeAllSlots()} 删除所有通知渠道。
   */
   ...
   * @see [addSlot]{@link notificationManager#addSlot(slotType: SlotType,callback: AsyncCallback<void>)} 创建通知频道。
   * @see [getSlot]{@link notificationManager#getSlot(slotType: SlotType,callback: AsyncCallback<NotificationSlot>)} 获取指定类型的通知渠道。
   * @see [removeSlot]{@link notificationManager#removeSlot(slotType: SlotType,callback: AsyncCallback<void>)} 删除所有通知渠道。
   */
   ...
   * @since 12 dynamic
   * @since 23 static
   * @see [requestEnableNotification]{@link notificationManager#requestEnableNotification(context: UIAbilityContext)} 请求通知使能。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [setBadgeNumber]{@link notificationManager#setBadgeNumber(badgeNumber: int,callback: AsyncCallback<void>)} 设置角标个数。
   */
   ...
   * @since 9 dynamic
   * @since 23 static
   * @see [setBadgeNumber]{@link notificationManager#setBadgeNumber(badgeNumber: int)} 设置角标个数。
   */
   ...
   * @since 10 dynamic
   * @since 23 static
   * @see [isNotificationEnabled]{@link notificationManager#isNotificationEnabled(callback: AsyncCallback<boolean>)} 查询当前应用通知授权状态。
   * @see [openNotificationSettings]{@link notificationManager#openNotificationSettings(context: UIAbilityContext)} 拉起当前应用的通知设置界面。
   ...
   * @since 10 dynamic
   * @since 23 static
   * @see [getActiveNotificationCount]{@link notificationManager#getActiveNotificationCount(callback: AsyncCallback<long>)} 获取当前应用的通知数量。
   */
   ...
   * @since 20 dynamic
   * @since 23 static
   * @see [openNotificationSettings]{@link notificationManager#openNotificationSettings(context: UIAbilityContext)} 拉起
   *     应用的通知设置界面。
   * @see [isNotificationEnabled]{@link notificationManager#isNotificationEnabled()} 获取指定应用的通知使能状态。
   */
   ...
   * @since 13 dynamic
   * @since 23 static
   * @see [requestEnableNotification]{@link notificationManager#requestEnableNotification(callback: AsyncCallback<void, void>)} 请求通知使能。
   * @see [isNotificationEnabled]{@link notificationManager#isNotificationEnabled(callback: AsyncCallback<boolean>)} 查询当前应用通知授权状态。
   * @see [getNotificationSetting]{@link notificationManager#getNotificationSetting()} 获取应用的通知设置状态。
   */
 ...
 /**
   ...
   * @since 22 dynamic
   * @since 23 static
   * @see [setBadgeNumber]{@link notificationManager#setBadgeNumber(badgeNumber: int)} 设定角标个数。
   */
