...
declare namespace batteryInfo {
   ...
   * 开发者需先订阅[COMMON_EVENT_BATTERY_CHANGED](docroot://reference/apis-basic-services-kit/common_event/commonEventManager-definitions.md#common_event_battery_changed)，
